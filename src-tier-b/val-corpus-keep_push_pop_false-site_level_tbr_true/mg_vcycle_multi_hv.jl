function initstacks_mg_vcycle_multi_b(nu1, nu2, num_levels)
...
function mg_vcycle_multi_hv(u, ub, f, fb, r, rb, nfine, num_levels, h1, h1b, nu1, nu2, n, ud, ubd, fd, fbd, rd, rbd, h1d, h1bd, hl2_stack, tripcount_stack, left_mg_relax_c1_stack, branch_stack, right_mg_relax_c1_stack, u_stack, left_stack, right_stack, r_stack, f_stack, hl_stack, cl_stack, cr_stack, left_mg_relax_c2_stack, right_mg_relax_c2_stack)
    hl2_stack_d = Vector{Float64}(undef, (((div((num_levels - 1) - 1, 1) + 1) + 1) + (div(1 - (num_levels - 1), -1) + 1)) + 1)
    ...
    hl_stack_d = Vector{Float64}(undef, ((div((num_levels - 1) - 1, 1) + 1) + (div(1 - (num_levels - 1), -1) + 1)) + 1)
    ...
    for i_seq_level = 1:num_levels - 1
        n = nl - 1
        hl2_stack_d[(i_seq_level - 1) + 1] = hl2d
        hl2_stack[(i_seq_level - 1) + 1] = hl2
        hl2d = hl * hld + hl * hld
        hl2 = hl * hl
        for i_seq_k_mg_relax_c1 = 1:nu1
            tripcount_stack[((i_seq_level - 1) * (div(nu1 - 1, 1) + 1) + (i_seq_k_mg_relax_c1 - 1)) + 1] = n
        ...
        nl = ncg
        hl_stack_d[(i_seq_level - 1) + 1] = hld
    ...
    hl2_stack_d[(div((num_levels - 1) - 1, 1) + 1) + 1] = hl2d
    ...
    for i_seq_level = num_levels - 1:-1:1
        nl = nl * 2
        hl_stack_d[(div((num_levels - 1) - 1, 1) + 1) + (div(i_seq_level - (num_levels - 1), -1) + 1)] = hld
        ...
        ncg = div(nl, 2)
        nc = ncg - 1
        hl2_stack_d[((div((num_levels - 1) - 1, 1) + 1) + 1) + (div(i_seq_level - (num_levels - 1), -1) + 1)] = hl2d
        ...
        for i_seq_k_mg_relax_c2 = 1:nu2
            tripcount_stack[((((((div((num_levels - 1) - 1, 1) + 1) * (div(nu1 - 1, 1) + 1) + (div((num_levels - 1) - 1, 1) + 1)) + (div((num_levels - 1) - 1, 1) + 1)) + (div((num_levels - 1) - 1, 1) + 1)) + (div(1 - (num_levels - 1), -1) + 1)) + (div(1 - (num_levels - 1), -1) + 1)) + ((div(i_seq_level - (num_levels - 1), -1) * (div(nu2 - 1, 1) + 1) + (i_seq_k_mg_relax_c2 - 1)) + 1)] = n
    ...
    push!(cr_stack_d, crd)
    push!(cr_stack, cr)
    hl_stack_d[((div((num_levels - 1) - 1, 1) + 1) + (div(1 - (num_levels - 1), -1) + 1)) + 1] = hld
    hl_stack[((div((num_levels - 1) - 1, 1) + 1) + (div(1 - (num_levels - 1), -1) + 1)) + 1] = hl
    hl2_stack_d[(((div((num_levels - 1) - 1, 1) + 1) + 1) + (div(1 - (num_levels - 1), -1) + 1)) + 1] = hl2d
    ...
    crd = pop!(cr_stack_d)
    cr = pop!(cr_stack)
    hld = hl_stack_d[((div((num_levels - 1) - 1, 1) + 1) + (div(1 - (num_levels - 1), -1) + 1)) + 1]
    hl = hl_stack[((div((num_levels - 1) - 1, 1) + 1) + (div(1 - (num_levels - 1), -1) + 1)) + 1]
    hl2d = hl2_stack_d[(((div((num_levels - 1) - 1, 1) + 1) + 1) + (div(1 - (num_levels - 1), -1) + 1)) + 1]
    ...
    for i_seq_level = 1:num_levels - 1
        ...
        for i_seq_k_mg_relax_c2 = nu2:-1:1
            ...
            right_mg_relax_c2d = pop!(right_mg_relax_c2_stack_d)
            right_mg_relax_c2 = pop!(right_mg_relax_c2_stack)
            n = tripcount_stack[((((((div((num_levels - 1) - 1, 1) + 1) * (div(nu1 - 1, 1) + 1) + (div((num_levels - 1) - 1, 1) + 1)) + (div((num_levels - 1) - 1, 1) + 1)) + (div((num_levels - 1) - 1, 1) + 1)) + (div(1 - (num_levels - 1), -1) + 1)) + (div(1 - (num_levels - 1), -1) + 1)) + ((div(i_seq_level - (num_levels - 1), -1) * (div(nu2 - 1, 1) + 1) + (i_seq_k_mg_relax_c2 - 1)) + 1)]
        ...
        hl2d = hl2_stack_d[((div((num_levels - 1) - 1, 1) + 1) + 1) + (div(i_seq_level - (num_levels - 1), -1) + 1)]
        ...
        hl2bd = 0.0
        hl2b = 0.0
        hld = hl_stack_d[(div((num_levels - 1) - 1, 1) + 1) + (div(i_seq_level - (num_levels - 1), -1) + 1)]
    ...
    ub[1, num_levels] = 0.0
    hl2d = hl2_stack_d[(div((num_levels - 1) - 1, 1) + 1) + 1]
    ...
    for i_seq_level = num_levels - 1:-1:1
        ...
        right_mg_relax_c1d = pop!(right_mg_relax_c1_stack_d)
        right_mg_relax_c1 = pop!(right_mg_relax_c1_stack)
        hld = hl_stack_d[(i_seq_level - 1) + 1]
        ...
        for i_seq_k_mg_relax_c1 = nu1:-1:1
            ...
            right_mg_relax_c1d = pop!(right_mg_relax_c1_stack_d)
            right_mg_relax_c1 = pop!(right_mg_relax_c1_stack)
            n = tripcount_stack[((i_seq_level - 1) * (div(nu1 - 1, 1) + 1) + (i_seq_k_mg_relax_c1 - 1)) + 1]
        ...
        hl2d = hl2_stack_d[(i_seq_level - 1) + 1]
