...
function ttgc_hv(u, ub, uref, urefb, i_cell_to_node, cell_vol, cell_volb, node_vol, node_volb, skx, skxb, sky, skyb, skz, skzb, i_ncell, i_nnode, c, cb, dt, dtb, beta, betab, gamma, gammab, i_njac, res, resb, res2, res2b, up, upb, mup, mupb, npernode_half, resperio, resperiob, i_node_perio, loss, lossb, ud, ubd, urefd, urefbd, cell_vold, cell_volbd, node_vold, node_volbd, skxd, skxbd, skyd, skybd, skzd, skzbd, cd, cbd, dtd, dtbd, betad, betabd, gammad, gammabd, resd, resbd, res2d, res2bd, upd, upbd, mupd, mupbd, resperiod, resperiobd, lossd, lossbd, cavgx_stack, cavgy_stack, cavgz_stack, vere_stack, re_stack, aerex_stack, aerey_stack, aerez_stack, aeresk_stack, factor_stack, res_stack, res2_stack, up_stack, mup_stack, auxu_stack)
    cavgx_stack_d = Vector{Float64}(undef, (((div(i_ncell - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(i_ncell - 1, 1) + 1)) + 1)
    cavgy_stack_d = Vector{Float64}(undef, (((div(i_ncell - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(i_ncell - 1, 1) + 1)) + 1)
    cavgz_stack_d = Vector{Float64}(undef, (((div(i_ncell - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(i_ncell - 1, 1) + 1)) + 1)
    vere_stack_d = Vector{Float64}(undef, ((((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1)) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(i_ncell - 1, 1) + 1)) + 1)
    re_stack_d = Vector{Float64}(undef, ((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1)) + 1)
    aerex_stack_d = Vector{Float64}(undef, ((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1)) + 1)
    aerey_stack_d = Vector{Float64}(undef, ((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1)) + 1)
    aerez_stack_d = Vector{Float64}(undef, ((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1)) + 1)
    aeresk_stack_d = Vector{Float64}(undef, (((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(i_ncell - 1, 1) + 1)) + 1)
    factor_stack_d = Vector{Float64}(undef, (((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(i_ncell - 1, 1) + 1)) + 1)
    res_stack_d = Vector{Float64}(undef, ((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(npernode_half - 1, 1) + 1)) + (div(npernode_half - 1, 1) + 1))
    res2_stack_d = Vector{Float64}(undef, (((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(npernode_half - 1, 1) + 1)) + (div(npernode_half - 1, 1) + 1))
    up_stack_d = Vector{Float64}(undef, (((div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + (div(i_nnode - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1))
    mup_stack_d = Vector{Float64}(undef, (((((((((((((div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(npernode_half - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(npernode_half - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(npernode_half - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(npernode_half - 1, 1) + 1))
    auxu_stack_d = Vector{Float64}(undef, ((((div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1) + (div(i_njac - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1)) + 1)
    aeresk = 0.0
    aerex = 0.0
    aerey = 0.0
    aerez = 0.0
    ...
    for i_cell = 1:i_ncell
        ...
        for i_loc = 1:4
            ...
            for i_k = 1:4
                ...
                res_stack_d[((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1] = resd[i_k_node]
                ...
                res2_stack_d[((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1] = res2d[i_k_node]
    ...
    for k = 1:npernode_half
        i1 = i_node_perio[k, 1]
        i2 = i_node_perio[k, 2]
        res_stack_d[(div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + ((k - 1) + 1)] = resd[i1]
        res_stack[(div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + ((k - 1) + 1)] = res[i1]
        resd[i1] = resd[i1] + resperiod[k, 2]
        res[i1] = res[i1] + resperio[k, 2]
        res_stack_d[((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(npernode_half - 1, 1) + 1)) + ((k - 1) + 1)] = resd[i2]
    ...
    for i_node = 1:i_nnode
        up_stack_d[(i_node - 1) + 1] = upd[i_node]
    ...
    for i_seq_ = 1:i_njac
        ...
        for i_node = 1:i_nnode
            up_stack_d[(div(i_nnode - 1, 1) + 1) + (((i_seq_ - 1) * (div(i_nnode - 1, 1) + 1) + (i_node - 1)) + 1)] = upd[i_node]
    ...
    for i_cell = 1:i_ncell
        for i_loc = 1:4
            ...
            for i_k = 1:4
                i_k_node = i_cell_to_node[i_k, i_cell]
                res2_stack_d[(div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1)] = res2d[i_k_node]
    ...
    for k = 1:npernode_half
        i1 = i_node_perio[k, 1]
        i2 = i_node_perio[k, 2]
        res2_stack_d[((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + ((k - 1) + 1)] = res2d[i1]
        ...
        res2_stack_d[(((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(npernode_half - 1, 1) + 1)) + ((k - 1) + 1)] = res2d[i2]
    ...
    for i_node = 1:i_nnode
        up_stack_d[((div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + ((i_node - 1) + 1)] = upd[i_node]
    ...
    for i_seq_ = 1:i_njac
        ...
        for i_node = 1:i_nnode
            up_stack_d[(((div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + (div(i_nnode - 1, 1) + 1)) + (((i_seq_ - 1) * (div(i_nnode - 1, 1) + 1) + (i_node - 1)) + 1)] = upd[i_node]
    ...
    for i_seq_ = i_njac:-1:1
        ...
        for i_node = i_nnode:-1:1
            upd[i_node] = up_stack_d[(((div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + (div(i_nnode - 1, 1) + 1)) + (((i_seq_ - 1) * (div(i_nnode - 1, 1) + 1) + (i_node - 1)) + 1)]
    ...
    for i_node = i_nnode:-1:1
        upd[i_node] = up_stack_d[((div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + ((i_node - 1) + 1)]
    ...
    for k = npernode_half:-1:1
        i1 = i_node_perio[k, 1]
        i2 = i_node_perio[k, 2]
        res2d[i2] = res2_stack_d[(((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(npernode_half - 1, 1) + 1)) + ((k - 1) + 1)]
        ...
        res2d[i1] = res2_stack_d[((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + ((k - 1) + 1)]
    ...
    for i_cell = i_ncell:-1:1
        ...
        for i_loc = 4:-1:1
            ...
            for i_k = 4:-1:1
                i_k_node = i_cell_to_node[i_k, i_cell]
                res2d[i_k_node] = res2_stack_d[(div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1)]
    ...
    for i_seq_ = i_njac:-1:1
        ...
        for i_node = i_nnode:-1:1
            upd[i_node] = up_stack_d[(div(i_nnode - 1, 1) + 1) + (((i_seq_ - 1) * (div(i_nnode - 1, 1) + 1) + (i_node - 1)) + 1)]
    ...
    for i_node = i_nnode:-1:1
        upd[i_node] = up_stack_d[(i_node - 1) + 1]
    ...
    for k = npernode_half:-1:1
        i1 = i_node_perio[k, 1]
        i2 = i_node_perio[k, 2]
        resd[i2] = res_stack_d[((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(npernode_half - 1, 1) + 1)) + ((k - 1) + 1)]
        ...
        resd[i1] = res_stack_d[(div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + ((k - 1) + 1)]
    ...
    for i_cell = i_ncell:-1:1
        ...
        for i_loc = 4:-1:1
            ...
            for i_k = 4:-1:1
                i_k_node = i_cell_to_node[i_k, i_cell]
                res2d[i_k_node] = res2_stack_d[((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1]
                ...
                resd[i_k_node] = res_stack_d[((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1]
