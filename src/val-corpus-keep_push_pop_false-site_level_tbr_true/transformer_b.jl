function initstacks_transformer_b(d, dff, dk, h, n, n_d, n_dff, n_layers)
    ...
    for i_seq_l = 1:n_layers
        ...
        for hh = 1:h
            ...
            for idx2 = 1:n * n
                ...
                scores_stack[((i_seq_l - 1) * ((div(h - 1, 1) + 1) * (div(n * n - 1, 1) + 1)) + (hh - 1) * (div(n * n - 1, 1) + 1) + (idx2 - 1)) + 1] = scores[(i - 1) * n + j]
    ...
    for i_seq_l = n_layers:-1:1
        ...
        for hh = h:-1:1
            ...
            for idx2 = n * n:-1:1
                ...
                i = div(idx2 - 1, n) + 1
                j = mod(idx2 - 1, n) + 1
                scores[(i - 1) * n + j] = scores_stack[((i_seq_l - 1) * ((div(h - 1, 1) + 1) * (div(n * n - 1, 1) + 1)) + (hh - 1) * (div(n * n - 1, 1) + 1) + (idx2 - 1)) + 1]
