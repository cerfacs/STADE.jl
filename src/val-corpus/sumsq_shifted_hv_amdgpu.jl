...
function initstacks_sumsq_shifted_b_amdgpu()
    return nothing
end

function sumsq_shifted_hv_amdgpu(loss, lossb, u, ub, alpha, alphab, beta, betab, i_n, lossd, lossbd, ud, ubd, alphad, alphabd, betad, betabd)
    for i_seq_x = 1:i_n
