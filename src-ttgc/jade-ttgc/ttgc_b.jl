...
function ttgc_b(u, ub, i_cell_to_node, cell_vol, cell_volb, skx, skxb, i_ncell, i_nnode, c, cb, dt, dtb, beta, betab, gamma, gammab, res, resb, up, upb, loss, lossb)
    ...
    for i_cell = 1:i_ncell
        ...
        for i_loc = 1:4
            ...
            ub[i_node] = ub[i_node] - (c[1, i_node] * skx[i_loc, i_cell] * vereb) / 3.0
