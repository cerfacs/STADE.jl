...
function metal_kernel_affine_loss_d_1!(a, ad, b, bd, i_n, u, ud, v, vd)
...
function affine_loss_d_metal(loss, lossd, u, ud, a, ad, b, bd, v, vd, i_n)
    nthread_per_block = 256
    @metal threads = nthread_per_block groups = cld(div(i_n - 1, 1) + 1, nthread_per_block) metal_kernel_affine_loss_d_1!(a, ad, b, bd, i_n, u, ud, v, vd)
    for i_seq_x = 1:i_n
