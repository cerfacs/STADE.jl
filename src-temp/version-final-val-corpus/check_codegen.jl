...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        v_stack = initstacks_affine_loss_b()
        affine_loss_b(loss, lossb, uu, ub, aa, ab, bb_, bbb, v, vb, n, v_stack)
...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        w_stack = initstacks_normcomp_b()
        normcomp_b(loss, lossb, uu, ub, vv, vb, w, wb, n, w_stack)
        return vcat(ub, vb)
    end
...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        p_stack, q_stack = initstacks_two_field_loss_b()
        two_field_loss_b(loss, lossb, uu, ub, vv, vb, p, pb, q, qb, n, p_stack, q_stack)
        return vcat(ub, vb)
    end
...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        v_stack, w_stack = initstacks_pipeline_b()
        pipeline_b(loss, lossb, xv, ub, v, vb, w, wb, n, v_stack, w_stack)
        return ub
    end
...
let n = 6, i_branch = 1
    ...
    f_grad = function (xv)
        ...
        ub = zeros(n); vb = zeros(n); w = zeros(n); wb = zeros(n)
        loss = [0.0]; lossb = [1.0]
        branch_stack, w_stack = initstacks_cond_field_choice_b()
        cond_field_choice_b(loss, lossb, uu, ub, vv, vb, w, wb, i_branch, n, branch_stack, w_stack)
        return vcat(ub, vb)
    end
...
let n = 6
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        branch_stack, v_stack = initstacks_relu_field_b()
        relu_field_b(loss, lossb, u, ub, v, vb, n, branch_stack, v_stack)
        return ub
    end
...
let n = 6
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        w_stack = initstacks_stencil_loss_b()
        stencil_loss_b(loss, lossb, u, ub, w, wb, n, w_stack)
        return ub
    end
