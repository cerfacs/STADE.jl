...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        loss_stack = initstacks_dotprod_b()
        dotprod_b(loss, lossb, u, ub, v, vb, n, loss_stack)
        return vcat(ub, vb)
    end
...
let m = 4, n = 3
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        loss_stack = initstacks_bilinear_b()
        bilinear_b(loss, lossb, xx, xb, aa, ab, yy, yb, m, n, loss_stack)
...
let m = 4, n = 3
    ...
    f_grad = function (xv)
        ...
        v_stack, loss_stack = initstacks_matvec_loss_b()
        matvec_loss_b(loss, lossb, aa, ab, uu, ub, v, vb, m, n, v_stack, loss_stack)
...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        v_stack, loss_stack = initstacks_affine_loss_b()
        affine_loss_b(loss, lossb, uu, ub, aa, ab, bb_, bbb, v, vb, n, v_stack, loss_stack)
...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        w_stack, loss_stack = initstacks_normcomp_b()
        normcomp_b(loss, lossb, uu, ub, vv, vb, w, wb, n, w_stack, loss_stack)
        return vcat(ub, vb)
    end
...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        loss_stack = initstacks_weightedsumsq_b()
        weightedsumsq_b(loss, lossb, uu, ub, ww, wb, n, loss_stack)
        return vcat(ub, wb)
    end
...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss_stack = initstacks_sumsq_shifted_b()
        alphab, betab = sumsq_shifted_b(loss, lossb, uu, ub, alpha, 0.0, beta, 0.0, n, loss_stack)
...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        p_stack, q_stack, loss_stack = initstacks_two_field_loss_b()
        two_field_loss_b(loss, lossb, uu, ub, vv, vb, p, pb, q, qb, n, p_stack, q_stack, loss_stack)
        return vcat(ub, vb)
    end
...
let n = 5
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        v_stack, w_stack, loss_stack = initstacks_pipeline_b()
        pipeline_b(loss, lossb, xv, ub, v, vb, w, wb, n, v_stack, w_stack, loss_stack)
        return ub
    end
...
let n = 6
    ...
    f_grad = function (xv)
        ...
        branch_stack, w_stack, loss_stack = initstacks_clamped_sumsq_b()
        clamped_sumsq_b(loss, lossb, u, ub, n, branch_stack, w_stack, loss_stack)
        return ub
    end
...
let n = 6, i_branch = 1
    ...
    f_grad = function (xv)
        ...
        ub = zeros(n); vb = zeros(n); w = zeros(n); wb = zeros(n)
        loss = [0.0]; lossb = [1.0]
        branch_stack, w_stack, loss_stack = initstacks_cond_field_choice_b()
        cond_field_choice_b(loss, lossb, uu, ub, vv, vb, w, wb, i_branch, n, branch_stack, w_stack, loss_stack)
        return vcat(ub, vb)
    end
...
let n = 6
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        branch_stack, v_stack, loss_stack = initstacks_relu_field_b()
        relu_field_b(loss, lossb, u, ub, v, vb, n, branch_stack, v_stack, loss_stack)
        return ub
    end
...
let n = 6
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        u_stack, loss_stack = initstacks_geomrecur_b()
        cb = geomrecur_b(loss, lossb, u, ub, c, 0.0, n, u_stack, loss_stack)
        return vcat(ub, [cb])
    end
...
let n = 6
    ...
    f_grad = function (xv)
        ...
        loss = [0.0]; lossb = [1.0]
        w_stack, loss_stack = initstacks_stencil_loss_b()
        stencil_loss_b(loss, lossb, u, ub, w, wb, n, w_stack, loss_stack)
        return ub
    end
...
let nnode = 5, nstep = 2
    ...
    f_grad = function (xv)
        ...
        du_stack, u_stack = initstacks_func_b()
        cb, dxb, dtb = func_b(u, ub, du, dub, c, 0.0, dx, 0.0, dt, 0.0, nstep, nnode, du_stack, u_stack)
...
println()
println("check_codegen.jl: M1/M2/M3 adjoint check done")
