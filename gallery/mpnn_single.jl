# mpnn_single(node_feat, edge_feat, src, dst, w_msg, b_msg, w_upd, b_upd,
...
function mpnn_single(node_feat, edge_feat, src, dst, w_msg, b_msg, w_upd, b_upd, n_nodes, n_edges, n_node_feat, n_edge_feat, n_msg_feat, msg_input, msg_scratch, messages, agg, upd_input, upd_scratch, node_feat_out)
