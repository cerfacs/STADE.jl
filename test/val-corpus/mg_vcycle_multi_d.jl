    ...
    for i_level = 1:num_levels - 1
        ...
        for i_k_mg_relax_c1 = 1:nu1
            for i_j_mg_relax_c1 = 1:n
                ...
                __cse_1 = f[i_j_mg_relax_c1, i_level]
                ud[i_j_mg_relax_c1, i_level] = 0.5 * (((__cse_1 * hl2d + hl2 * fd[i_j_mg_relax_c1, i_level]) + left_mg_relax_c1d) + right_mg_relax_c1d)
                u[i_j_mg_relax_c1, i_level] = 0.5 * (hl2 * __cse_1 + left_mg_relax_c1 + right_mg_relax_c1)
            end
        end
        for j = 1:n
            leftd = 0.0
    ...
    for i_level = num_levels - 1:-1:1
        ...
        for i_k_mg_relax_c2 = 1:nu2
            for i_j_mg_relax_c2 = 1:n
                ...
                __cse_6 = f[i_j_mg_relax_c2, i_level]
                ud[i_j_mg_relax_c2, i_level] = 0.5 * (((__cse_6 * hl2d + hl2 * fd[i_j_mg_relax_c2, i_level]) + left_mg_relax_c2d) + right_mg_relax_c2d)
                u[i_j_mg_relax_c2, i_level] = 0.5 * (hl2 * __cse_6 + left_mg_relax_c2 + right_mg_relax_c2)
            end
        end
    end
    return nothing
