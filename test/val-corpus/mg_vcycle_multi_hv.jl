...
function mg_vcycle_multi_hv(u, ub, f, fb, r, rb, nfine, num_levels, h1, h1b, nu1, nu2, n, ud, ubd, fd, fbd, rd, rbd, h1d, h1bd, hl2_stack, tripcount_stack, branch_stack, u_stack, r_stack, f_stack, hl_stack, cl_stack, cr_stack, left_stack, left_mg_relax_c1_stack, left_mg_relax_c2_stack, right_stack, right_mg_relax_c1_stack, right_mg_relax_c2_stack, prefix_branch_stack_1, prefix_f_stack_1, prefix_hl2_stack_1, prefix_hl_stack_1, prefix_left_mg_relax_c1_stack_1, prefix_left_stack_1, prefix_r_stack_1, prefix_right_mg_relax_c1_stack_1, prefix_right_stack_1, prefix_tripcount_stack_1, prefix_u_stack_1, prefix_branch_stack_2, prefix_cl_stack_2, prefix_cr_stack_2, prefix_hl2_stack_2, prefix_hl_stack_2, prefix_left_mg_relax_c2_stack_2, prefix_right_mg_relax_c2_stack_2, prefix_tripcount_stack_2, prefix_u_stack_2, __tot_branch_stack_1, __tot_f_stack_1, __tot_hl2_stack_1, __tot_hl_stack_1, __tot_left_mg_relax_c1_stack_1, __tot_left_stack_1, __tot_r_stack_1, __tot_right_mg_relax_c1_stack_1, __tot_right_stack_1, __tot_tripcount_stack_1, __tot_u_stack_1, __tot_branch_stack_2, __tot_cl_stack_2, __tot_cr_stack_2, __tot_hl2_stack_2, __tot_hl_stack_2, __tot_left_mg_relax_c2_stack_2, __tot_right_mg_relax_c2_stack_2, __tot_tripcount_stack_2, __tot_u_stack_2, val_n_1, val_nc_1, val_n_2, val_nc_2)
    ...
    for i_level = 1:num_levels - 1
        ...
        for i_k_mg_relax_c1 = 1:nu1
            ...
            for i_j_mg_relax_c1 = 1:n
                ...
                if i_j_mg_relax_c1 < n
                    __idx_branch_stack_1_0 = (prefix_branch_stack_1[(i_level - 1) + 1] + max(0, div(nu1 - 1, 1) + 1) * max(0, div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
                    branch_stack[__idx_branch_stack_1_0] = 1
                ...
                __cse_16 = f[i_j_mg_relax_c1, i_level]
                ud[i_j_mg_relax_c1, i_level] = 0.5 * (((__cse_16 * hl2d + hl2 * fd[i_j_mg_relax_c1, i_level]) + left_mg_relax_c1d) + right_mg_relax_c1d)
                u[i_j_mg_relax_c1, i_level] = 0.5 * (hl2 * __cse_16 + left_mg_relax_c1 + right_mg_relax_c1)
        ...
        for j = 1:n
            ...
            __cse_17 = (2.0 * u[j, i_level] - left) - right
            rd[j, i_level] = fd[j, i_level] + -(((1.0 / hl2) * ((2.0 * ud[j, i_level] + -leftd) + -rightd) + -(__cse_17 / hl2 ^ 2) * hl2d))
            r[j, i_level] = f[j, i_level] - __cse_17 / hl2
    ...
    __cse_18 = hl * hld
    hl2d = __cse_18 + __cse_18
    hl2 = hl * hl
    __idx_u_stack_7 = __tot_u_stack_1 + 1
    u_stack_d[__idx_u_stack_7] = ud[1, num_levels]
    u_stack[__idx_u_stack_7] = u[1, num_levels]
    __cse_19 = f[1, num_levels]
    ud[1, num_levels] = (0.5__cse_19) * hl2d + (0.5hl2) * fd[1, num_levels]
    u[1, num_levels] = 0.5 * hl2 * __cse_19
    for i_level = num_levels - 1:-1:1
        nl = nl * 2
        ...
        for j = 1:nc
            ...
            __cse_0d = ud[jf, i_level]
            __cse_0 = u[jf, i_level]
            u_stack_d[__idx_u_stack_2_1] = __cse_0d
            u_stack[__idx_u_stack_2_1] = __cse_0
            ud[jf, i_level] = __cse_0d + ud[j, i_level + 1]
        ...
        for j = 1:nc + 1
            ...
            __cse_1d = ud[jf, i_level]
            __cse_1 = u[jf, i_level]
            u_stack_d[__idx_u_stack_2_5] = __cse_1d
            u_stack[__idx_u_stack_2_5] = __cse_1
            ud[jf, i_level] = __cse_1d + 0.5 * (cld + crd)
        ...
        for i_k_mg_relax_c2 = 1:nu2
            ...
            for i_j_mg_relax_c2 = 1:n
                ...
                if i_j_mg_relax_c2 > 1
                    __idx_branch_stack_2_0 = ((__tot_branch_stack_1 + prefix_branch_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (max(0, div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + max(0, div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                    branch_stack[__idx_branch_stack_2_0] = 1
                ...
                if i_j_mg_relax_c2 < n
                    __idx_branch_stack_2_0 = ((__tot_branch_stack_1 + prefix_branch_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((max(0, div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + max(0, div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1)) + max(0, div(nu2 - 1, 1) + 1) * max(0, div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                    branch_stack[__idx_branch_stack_2_0] = 1
                ...
                __idx_u_stack_2_4 = (((__tot_u_stack_1 + 1) + prefix_u_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (max(0, div(val_nc_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + max(0, div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                u_stack_d[__idx_u_stack_2_4] = ud[i_j_mg_relax_c2, i_level]
                u_stack[__idx_u_stack_2_4] = u[i_j_mg_relax_c2, i_level]
                __cse_21 = f[i_j_mg_relax_c2, i_level]
                ud[i_j_mg_relax_c2, i_level] = 0.5 * (((__cse_21 * hl2d + hl2 * fd[i_j_mg_relax_c2, i_level]) + left_mg_relax_c2d) + right_mg_relax_c2d)
                u[i_j_mg_relax_c2, i_level] = 0.5 * (hl2 * __cse_21 + left_mg_relax_c2 + right_mg_relax_c2)
    ...
    for i_level = 1:num_levels - 1
        for i_k_mg_relax_c2 = nu2:-1:1
            ...
            for i_j_mg_relax_c2 = n:-1:1
                ...
                __idx_branch_stack_2_8 = ((__tot_branch_stack_1 + prefix_branch_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (max(0, div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + max(0, div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                ...
                __idx_u_stack_2_0 = (((__tot_u_stack_1 + 1) + prefix_u_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (max(0, div(val_nc_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + max(0, div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                ud[i_j_mg_relax_c2, i_level] = u_stack_d[__idx_u_stack_2_0]
                u[i_j_mg_relax_c2, i_level] = u_stack[__idx_u_stack_2_0]
                __cse_2d = 0.5 * ubd[i_j_mg_relax_c2, i_level]
                __cse_2 = 0.5 * ub[i_j_mg_relax_c2, i_level]
                __cse_22 = f[i_j_mg_relax_c2, i_level]
                hl2bd = hl2bd + (__cse_2 * fd[i_j_mg_relax_c2, i_level] + __cse_22 * __cse_2d)
                hl2b = hl2b + __cse_22 * __cse_2
                fbd[i_j_mg_relax_c2, i_level] = fbd[i_j_mg_relax_c2, i_level] + (__cse_2 * hl2d + hl2 * __cse_2d)
                fb[i_j_mg_relax_c2, i_level] = fb[i_j_mg_relax_c2, i_level] + hl2 * __cse_2
                left_mg_relax_c2bd = left_mg_relax_c2bd + __cse_2d
                left_mg_relax_c2b = left_mg_relax_c2b + __cse_2
                right_mg_relax_c2bd = right_mg_relax_c2bd + __cse_2d
                right_mg_relax_c2b = right_mg_relax_c2b + __cse_2
    ...
    __cse_5d = ubd[1, num_levels]
    __cse_5 = ub[1, num_levels]
    __cse_23 = 0.5 * f[1, num_levels]
    hl2bd = hl2bd + (__cse_5 * (0.5 * fd[1, num_levels]) + __cse_23 * __cse_5d)
    hl2b = hl2b + __cse_23 * __cse_5
    __cse_24 = 0.5hl2
    fbd[1, num_levels] = fbd[1, num_levels] + (__cse_5 * (0.5hl2d) + __cse_24 * __cse_5d)
    fb[1, num_levels] = fb[1, num_levels] + __cse_24 * __cse_5
    ...
    for i_level = num_levels - 1:-1:1
        ...
        for j = nc:-1:1
            ...
            __cse_7d = fbd[j, i_level + 1]
            __cse_7 = fb[j, i_level + 1]
            __cse_8d = 0.25__cse_7d
            __cse_8 = 0.25__cse_7
            rbd[jf - 1, i_level] = rbd[jf - 1, i_level] + __cse_8d
            rb[jf - 1, i_level] = rb[jf - 1, i_level] + __cse_8
            rbd[jf, i_level] = rbd[jf, i_level] + 0.5__cse_7d
        ...
        for j = n:-1:1
            ...
            __cse_9d = rbd[j, i_level]
            __cse_9 = rb[j, i_level]
            fbd[j, i_level] = fbd[j, i_level] + __cse_9d
            fb[j, i_level] = fb[j, i_level] + __cse_9
            __cse_10d = -__cse_9d
            __cse_10 = -__cse_9
            __cse_25 = hl2 ^ 2
            __cse_26 = 1.0 / __cse_25
            __cse_27 = 1.0 / hl2
            __cse_11d = __cse_10 * (-__cse_26 * hl2d) + __cse_27 * __cse_10d
            __cse_11 = __cse_27 * __cse_10
            ubd[j, i_level] = ubd[j, i_level] + 2.0__cse_11d
            ub[j, i_level] = ub[j, i_level] + 2.0__cse_11
            __cse_12d = -__cse_11d
            __cse_12 = -__cse_11
            leftbd = leftbd + __cse_12d
            leftb = leftb + __cse_12
            rightbd = rightbd + __cse_12d
            rightb = rightb + __cse_12
            __cse_28 = (2.0 * u[j, i_level] - left) - right
            __cse_29 = -(__cse_28 / __cse_25)
            hl2bd = hl2bd + (__cse_10 * -((__cse_26 * ((2.0 * ud[j, i_level] + -leftd) + -rightd) + -(__cse_28 / __cse_25 ^ 2) * ((2hl2) * hl2d))) + __cse_29 * __cse_10d)
            hl2b = hl2b + __cse_29 * __cse_10
            rbd[j, i_level] = 0.0
            rb[j, i_level] = 0.0
            if __branch_pre_4 == 1
        ...
        for i_k_mg_relax_c1 = nu1:-1:1
            ...
            for i_j_mg_relax_c1 = n:-1:1
                ...
                __idx_branch_stack_1_4 = (prefix_branch_stack_1[(i_level - 1) + 1] + max(0, div(nu1 - 1, 1) + 1) * max(0, div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
                __branch_pre_4 = branch_stack[__idx_branch_stack_1_4]
                right_mg_relax_c1d = 0.0
                right_mg_relax_c1 = 0.0
                if __branch_pre_4 == 1
                ...
                __cse_13d = 0.5 * ubd[i_j_mg_relax_c1, i_level]
                __cse_13 = 0.5 * ub[i_j_mg_relax_c1, i_level]
                __cse_30 = f[i_j_mg_relax_c1, i_level]
                hl2bd = hl2bd + (__cse_13 * fd[i_j_mg_relax_c1, i_level] + __cse_30 * __cse_13d)
                hl2b = hl2b + __cse_30 * __cse_13
                fbd[i_j_mg_relax_c1, i_level] = fbd[i_j_mg_relax_c1, i_level] + (__cse_13 * hl2d + hl2 * __cse_13d)
                fb[i_j_mg_relax_c1, i_level] = fb[i_j_mg_relax_c1, i_level] + hl2 * __cse_13
                left_mg_relax_c1bd = left_mg_relax_c1bd + __cse_13d
                left_mg_relax_c1b = left_mg_relax_c1b + __cse_13
                right_mg_relax_c1bd = right_mg_relax_c1bd + __cse_13d
                right_mg_relax_c1b = right_mg_relax_c1b + __cse_13
