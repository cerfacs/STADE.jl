...
function mg_vcycle_multi_hv(u, ub, f, fb, r, rb, nfine, num_levels, h1, h1b, nu1, nu2, n, ud, ubd, fd, fbd, rd, rbd, h1d, h1bd, hl2_stack, tripcount_stack, left_mg_relax_c1_stack, branch_stack, right_mg_relax_c1_stack, u_stack, left_stack, right_stack, r_stack, f_stack, hl_stack, cl_stack, cr_stack, left_mg_relax_c2_stack, right_mg_relax_c2_stack, prefix_branch_stack_1, prefix_f_stack_1, prefix_hl2_stack_1, prefix_hl_stack_1, prefix_left_mg_relax_c1_stack_1, prefix_left_stack_1, prefix_r_stack_1, prefix_right_mg_relax_c1_stack_1, prefix_right_stack_1, prefix_tripcount_stack_1, prefix_u_stack_1, prefix_branch_stack_2, prefix_cl_stack_2, prefix_cr_stack_2, prefix_hl2_stack_2, prefix_hl_stack_2, prefix_left_mg_relax_c2_stack_2, prefix_right_mg_relax_c2_stack_2, prefix_tripcount_stack_2, prefix_u_stack_2, __tot_branch_stack_1, __tot_f_stack_1, __tot_hl2_stack_1, __tot_hl_stack_1, __tot_left_mg_relax_c1_stack_1, __tot_left_stack_1, __tot_r_stack_1, __tot_right_mg_relax_c1_stack_1, __tot_right_stack_1, __tot_tripcount_stack_1, __tot_u_stack_1, __tot_branch_stack_2, __tot_cl_stack_2, __tot_cr_stack_2, __tot_hl2_stack_2, __tot_hl_stack_2, __tot_left_mg_relax_c2_stack_2, __tot_right_mg_relax_c2_stack_2, __tot_tripcount_stack_2, __tot_u_stack_2, val_n_1, val_nc_1, val_n_2, val_nc_2)
    ...
    for i_level = 1:num_levels - 1
        ...
        for i_k_mg_relax_c1 = 1:nu1
            ...
            for i_j_mg_relax_c1 = 1:n
                ...
                if i_j_mg_relax_c1 > 1
                    ...
                    __idx_left_mg_relax_c1_stack_1_0 = (prefix_left_mg_relax_c1_stack_1[(i_level - 1) + 1] + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
                    left_mg_relax_c1_stack_d[__idx_left_mg_relax_c1_stack_1_0] = left_mg_relax_c1d
                    left_mg_relax_c1_stack[__idx_left_mg_relax_c1_stack_1_0] = left_mg_relax_c1
                ...
                __idx_right_mg_relax_c1_stack_1_4 = prefix_right_mg_relax_c1_stack_1[(i_level - 1) + 1] + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
                ...
                if i_j_mg_relax_c1 < n
                    ...
                    branch_stack[__idx_branch_stack_1_0] = 1
                    __idx_right_mg_relax_c1_stack_1_0 = (prefix_right_mg_relax_c1_stack_1[(i_level - 1) + 1] + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
                ...
                __idx_u_stack_1_8 = prefix_u_stack_1[(i_level - 1) + 1] + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
                u_stack_d[__idx_u_stack_1_8] = ud[i_j_mg_relax_c1, i_level]
                u_stack[__idx_u_stack_1_8] = u[i_j_mg_relax_c1, i_level]
                ud[i_j_mg_relax_c1, i_level] = 0.5 * (((f[i_j_mg_relax_c1, i_level] * hl2d + hl2 * fd[i_j_mg_relax_c1, i_level]) + left_mg_relax_c1d) + right_mg_relax_c1d)
                u[i_j_mg_relax_c1, i_level] = 0.5 * (hl2 * f[i_j_mg_relax_c1, i_level] + left_mg_relax_c1 + right_mg_relax_c1)
                __idx_left_mg_relax_c1_stack_1_11 = (prefix_left_mg_relax_c1_stack_1[(i_level - 1) + 1] + ((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
                ...
                __idx_right_mg_relax_c1_stack_1_13 = (prefix_right_mg_relax_c1_stack_1[(i_level - 1) + 1] + ((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
            ...
            __idx_left_mg_relax_c1_stack_1_3 = (prefix_left_mg_relax_c1_stack_1[(i_level - 1) + 1] + (((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((i_k_mg_relax_c1 - 1) + 1)
            ...
            __idx_right_mg_relax_c1_stack_1_5 = (prefix_right_mg_relax_c1_stack_1[(i_level - 1) + 1] + (((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((i_k_mg_relax_c1 - 1) + 1)
        ...
        for j = 1:n
            ...
            if j > 1
                ...
                branch_stack[__idx_branch_stack_1_0] = 1
                __idx_left_stack_1_0 = (prefix_left_stack_1[(i_level - 1) + 1] + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + ((j - 1) + 1)
                left_stack_d[__idx_left_stack_1_0] = leftd
                left_stack[__idx_left_stack_1_0] = left
            ...
            __idx_right_stack_1_4 = prefix_right_stack_1[(i_level - 1) + 1] + ((j - 1) + 1)
            ...
            if j < n
                ...
                branch_stack[__idx_branch_stack_1_0] = 1
                __idx_right_stack_1_0 = (prefix_right_stack_1[(i_level - 1) + 1] + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + ((j - 1) + 1)
            ...
            __idx_r_stack_1_8 = prefix_r_stack_1[(i_level - 1) + 1] + ((j - 1) + 1)
            r_stack_d[__idx_r_stack_1_8] = rd[j, i_level]
            r_stack[__idx_r_stack_1_8] = r[j, i_level]
            ...
            __idx_left_stack_1_11 = (prefix_left_stack_1[(i_level - 1) + 1] + ((div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((j - 1) + 1)
            left_stack_d[__idx_left_stack_1_11] = leftd
            left_stack[__idx_left_stack_1_11] = left
            __idx_right_stack_1_13 = (prefix_right_stack_1[(i_level - 1) + 1] + ((div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((j - 1) + 1)
        ...
        hld = 2.0hld
        hl = hl * 2.0
        __idx_left_stack_1_20 = (prefix_left_stack_1[(i_level - 1) + 1] + (((div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + 1
        left_stack_d[__idx_left_stack_1_20] = leftd
        left_stack[__idx_left_stack_1_20] = left
        __idx_left_mg_relax_c1_stack_1_22 = (prefix_left_mg_relax_c1_stack_1[(i_level - 1) + 1] + ((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1))) + 1
        ...
        __idx_right_stack_1_24 = (prefix_right_stack_1[(i_level - 1) + 1] + (((div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + 1
        right_stack_d[__idx_right_stack_1_24] = rightd
        right_stack[__idx_right_stack_1_24] = right
        __idx_right_mg_relax_c1_stack_1_26 = (prefix_right_mg_relax_c1_stack_1[(i_level - 1) + 1] + ((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1))) + 1
    ...
    for i_level = num_levels - 1:-1:1
        ...
        for j = 1:nc + 1
            jf = j * 2 - 1
            __idx_cl_stack_2_1 = prefix_cl_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((j - 1) + 1)
            ...
            if j > 1
                ...
                __idx_cl_stack_2_0 = (prefix_cl_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1)) + ((j - 1) + 1)
            ...
            __idx_cr_stack_2_5 = prefix_cr_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((j - 1) + 1)
            ...
            if j <= nc
                ...
                branch_stack[__idx_branch_stack_2_0] = 1
                __idx_cr_stack_2_0 = (prefix_cr_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1)) + ((j - 1) + 1)
            ...
            __idx_u_stack_2_9 = (((__tot_u_stack_1 + 1) + prefix_u_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (div(val_nc_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + ((j - 1) + 1)
            u_stack_d[__idx_u_stack_2_9] = ud[jf, i_level]
            u_stack[__idx_u_stack_2_9] = u[jf, i_level]
            ud[jf, i_level] = ud[jf, i_level] + 0.5 * (cld + crd)
            u[jf, i_level] = u[jf, i_level] + 0.5 * (cl + cr)
            __idx_cl_stack_2_12 = (prefix_cl_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + ((j - 1) + 1)
            cl_stack_d[__idx_cl_stack_2_12] = cld
            cl_stack[__idx_cl_stack_2_12] = cl
            __idx_cr_stack_2_14 = (prefix_cr_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + ((j - 1) + 1)
        ...
        for i_k_mg_relax_c2 = 1:nu2
            ...
            for i_j_mg_relax_c2 = 1:n
                ...
                if i_j_mg_relax_c2 > 1
                    ...
                    branch_stack[__idx_branch_stack_2_0] = 1
                    __idx_left_mg_relax_c2_stack_2_0 = (prefix_left_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                    left_mg_relax_c2_stack_d[__idx_left_mg_relax_c2_stack_2_0] = left_mg_relax_c2d
                    left_mg_relax_c2_stack[__idx_left_mg_relax_c2_stack_2_0] = left_mg_relax_c2
                ...
                __idx_right_mg_relax_c2_stack_2_4 = prefix_right_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                ...
                if i_j_mg_relax_c2 < n
                    ...
                    branch_stack[__idx_branch_stack_2_0] = 1
                    __idx_right_mg_relax_c2_stack_2_0 = (prefix_right_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                ...
                __idx_u_stack_2_8 = (((__tot_u_stack_1 + 1) + prefix_u_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((div(val_nc_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                u_stack_d[__idx_u_stack_2_8] = ud[i_j_mg_relax_c2, i_level]
                u_stack[__idx_u_stack_2_8] = u[i_j_mg_relax_c2, i_level]
                ud[i_j_mg_relax_c2, i_level] = 0.5 * (((f[i_j_mg_relax_c2, i_level] * hl2d + hl2 * fd[i_j_mg_relax_c2, i_level]) + left_mg_relax_c2d) + right_mg_relax_c2d)
                u[i_j_mg_relax_c2, i_level] = 0.5 * (hl2 * f[i_j_mg_relax_c2, i_level] + left_mg_relax_c2 + right_mg_relax_c2)
                __idx_left_mg_relax_c2_stack_2_11 = (prefix_left_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                ...
                __idx_right_mg_relax_c2_stack_2_13 = (prefix_right_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
            ...
            __idx_left_mg_relax_c2_stack_2_3 = (prefix_left_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + ((i_k_mg_relax_c2 - 1) + 1)
            ...
            __idx_right_mg_relax_c2_stack_2_5 = (prefix_right_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + ((i_k_mg_relax_c2 - 1) + 1)
        ...
        __idx_cl_stack_2_17 = (prefix_cl_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (((div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1)) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + 1
        cl_stack_d[__idx_cl_stack_2_17] = cld
        cl_stack[__idx_cl_stack_2_17] = cl
        __idx_cr_stack_2_19 = (prefix_cr_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (((div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1)) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + 1
        cr_stack_d[__idx_cr_stack_2_19] = crd
        cr_stack[__idx_cr_stack_2_19] = cr
        __idx_left_mg_relax_c2_stack_2_21 = (prefix_left_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1))) + 1
        ...
        __idx_right_mg_relax_c2_stack_2_23 = (prefix_right_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1))) + 1
    ...
    for i_level = 1:num_levels - 1
        __idx_cl_stack_2_0 = (prefix_cl_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (((div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1)) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + 1
        cld = cl_stack_d[__idx_cl_stack_2_0]
        cl = cl_stack[__idx_cl_stack_2_0]
        __idx_cr_stack_2_2 = (prefix_cr_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (((div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1)) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + 1
        crd = cr_stack_d[__idx_cr_stack_2_2]
        cr = cr_stack[__idx_cr_stack_2_2]
        __idx_left_mg_relax_c2_stack_2_4 = (prefix_left_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1))) + 1
        ...
        __idx_right_mg_relax_c2_stack_2_6 = (prefix_right_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1))) + 1
        ...
        for i_k_mg_relax_c2 = nu2:-1:1
            __idx_left_mg_relax_c2_stack_2_0 = (prefix_left_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + ((i_k_mg_relax_c2 - 1) + 1)
            ...
            __idx_right_mg_relax_c2_stack_2_2 = (prefix_right_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + ((i_k_mg_relax_c2 - 1) + 1)
            ...
            for i_j_mg_relax_c2 = n:-1:1
                __idx_left_mg_relax_c2_stack_2_0 = (prefix_left_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                left_mg_relax_c2d = left_mg_relax_c2_stack_d[__idx_left_mg_relax_c2_stack_2_0]
                left_mg_relax_c2 = left_mg_relax_c2_stack[__idx_left_mg_relax_c2_stack_2_0]
                __idx_right_mg_relax_c2_stack_2_2 = (prefix_right_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                right_mg_relax_c2d = right_mg_relax_c2_stack_d[__idx_right_mg_relax_c2_stack_2_2]
                right_mg_relax_c2 = right_mg_relax_c2_stack[__idx_right_mg_relax_c2_stack_2_2]
                ...
                hl2bd = hl2bd + ((0.5 * ub[i_j_mg_relax_c2, i_level]) * fd[i_j_mg_relax_c2, i_level] + f[i_j_mg_relax_c2, i_level] * (0.5 * ubd[i_j_mg_relax_c2, i_level]))
                hl2b = hl2b + f[i_j_mg_relax_c2, i_level] * (0.5 * ub[i_j_mg_relax_c2, i_level])
                fbd[i_j_mg_relax_c2, i_level] = fbd[i_j_mg_relax_c2, i_level] + ((0.5 * ub[i_j_mg_relax_c2, i_level]) * hl2d + hl2 * (0.5 * ubd[i_j_mg_relax_c2, i_level]))
                fb[i_j_mg_relax_c2, i_level] = fb[i_j_mg_relax_c2, i_level] + hl2 * (0.5 * ub[i_j_mg_relax_c2, i_level])
                left_mg_relax_c2bd = left_mg_relax_c2bd + 0.5 * ubd[i_j_mg_relax_c2, i_level]
                left_mg_relax_c2b = left_mg_relax_c2b + 0.5 * ub[i_j_mg_relax_c2, i_level]
                right_mg_relax_c2bd = right_mg_relax_c2bd + 0.5 * ubd[i_j_mg_relax_c2, i_level]
                ...
                if __branch_pre_4 == 1
                    ubd[i_j_mg_relax_c2 + 1, i_level] = ubd[i_j_mg_relax_c2 + 1, i_level] + right_mg_relax_c2bd
                    ub[i_j_mg_relax_c2 + 1, i_level] = ub[i_j_mg_relax_c2 + 1, i_level] + right_mg_relax_c2b
                    right_mg_relax_c2bd = 0.0
                    right_mg_relax_c2b = 0.0
                end
                __idx_right_mg_relax_c2_stack_2_0 = prefix_right_mg_relax_c2_stack_2[div(i_level - (num_levels - 1), -1) + 1] + (((i_k_mg_relax_c2 - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c2 - 1)) + 1)
                ...
                right_mg_relax_c2b = 0.0
                if __branch_pre_2 == 1
                    ubd[i_j_mg_relax_c2 - 1, i_level] = ubd[i_j_mg_relax_c2 - 1, i_level] + left_mg_relax_c2bd
        ...
        for j = nc + 1:-1:1
            __idx_cl_stack_2_0 = (prefix_cl_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + ((j - 1) + 1)
            cld = cl_stack_d[__idx_cl_stack_2_0]
            cl = cl_stack[__idx_cl_stack_2_0]
            __idx_cr_stack_2_2 = (prefix_cr_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + ((j - 1) + 1)
            crd = cr_stack_d[__idx_cr_stack_2_2]
            cr = cr_stack[__idx_cr_stack_2_2]
            jf = j * 2 - 1
            ...
            __idx_cr_stack_2_0 = prefix_cr_stack_2[div(i_level - (num_levels - 1), -1) + 1] + ((j - 1) + 1)
    ...
    hl2b = 0.0
    for i_level = num_levels - 1:-1:1
        __idx_left_stack_1_0 = (prefix_left_stack_1[(i_level - 1) + 1] + (((div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + 1
        leftd = left_stack_d[__idx_left_stack_1_0]
        left = left_stack[__idx_left_stack_1_0]
        __idx_left_mg_relax_c1_stack_1_2 = (prefix_left_mg_relax_c1_stack_1[(i_level - 1) + 1] + ((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1))) + 1
        ...
        __idx_right_stack_1_4 = (prefix_right_stack_1[(i_level - 1) + 1] + (((div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + 1
        rightd = right_stack_d[__idx_right_stack_1_4]
        right = right_stack[__idx_right_stack_1_4]
        __idx_right_mg_relax_c1_stack_1_6 = (prefix_right_mg_relax_c1_stack_1[(i_level - 1) + 1] + ((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1))) + 1
        ...
        for j = n:-1:1
            __idx_left_stack_1_0 = (prefix_left_stack_1[(i_level - 1) + 1] + ((div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((j - 1) + 1)
            leftd = left_stack_d[__idx_left_stack_1_0]
            left = left_stack[__idx_left_stack_1_0]
            __idx_right_stack_1_2 = (prefix_right_stack_1[(i_level - 1) + 1] + ((div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((j - 1) + 1)
            ...
            __idx_right_stack_1_0 = prefix_right_stack_1[(i_level - 1) + 1] + ((j - 1) + 1)
        ...
        for i_k_mg_relax_c1 = nu1:-1:1
            __idx_left_mg_relax_c1_stack_1_0 = (prefix_left_mg_relax_c1_stack_1[(i_level - 1) + 1] + (((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((i_k_mg_relax_c1 - 1) + 1)
            ...
            __idx_right_mg_relax_c1_stack_1_2 = (prefix_right_mg_relax_c1_stack_1[(i_level - 1) + 1] + (((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((i_k_mg_relax_c1 - 1) + 1)
            ...
            for i_j_mg_relax_c1 = n:-1:1
                __idx_left_mg_relax_c1_stack_1_0 = (prefix_left_mg_relax_c1_stack_1[(i_level - 1) + 1] + ((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
                left_mg_relax_c1d = left_mg_relax_c1_stack_d[__idx_left_mg_relax_c1_stack_1_0]
                left_mg_relax_c1 = left_mg_relax_c1_stack[__idx_left_mg_relax_c1_stack_1_0]
                __idx_right_mg_relax_c1_stack_1_2 = (prefix_right_mg_relax_c1_stack_1[(i_level - 1) + 1] + ((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
                right_mg_relax_c1d = right_mg_relax_c1_stack_d[__idx_right_mg_relax_c1_stack_1_2]
                right_mg_relax_c1 = right_mg_relax_c1_stack[__idx_right_mg_relax_c1_stack_1_2]
                ...
                hl2bd = hl2bd + ((0.5 * ub[i_j_mg_relax_c1, i_level]) * fd[i_j_mg_relax_c1, i_level] + f[i_j_mg_relax_c1, i_level] * (0.5 * ubd[i_j_mg_relax_c1, i_level]))
                hl2b = hl2b + f[i_j_mg_relax_c1, i_level] * (0.5 * ub[i_j_mg_relax_c1, i_level])
                fbd[i_j_mg_relax_c1, i_level] = fbd[i_j_mg_relax_c1, i_level] + ((0.5 * ub[i_j_mg_relax_c1, i_level]) * hl2d + hl2 * (0.5 * ubd[i_j_mg_relax_c1, i_level]))
                fb[i_j_mg_relax_c1, i_level] = fb[i_j_mg_relax_c1, i_level] + hl2 * (0.5 * ub[i_j_mg_relax_c1, i_level])
                left_mg_relax_c1bd = left_mg_relax_c1bd + 0.5 * ubd[i_j_mg_relax_c1, i_level]
                left_mg_relax_c1b = left_mg_relax_c1b + 0.5 * ub[i_j_mg_relax_c1, i_level]
                right_mg_relax_c1bd = right_mg_relax_c1bd + 0.5 * ubd[i_j_mg_relax_c1, i_level]
                ...
                if __branch_pre_4 == 1
                    ubd[i_j_mg_relax_c1 + 1, i_level] = ubd[i_j_mg_relax_c1 + 1, i_level] + right_mg_relax_c1bd
                    ub[i_j_mg_relax_c1 + 1, i_level] = ub[i_j_mg_relax_c1 + 1, i_level] + right_mg_relax_c1b
                    right_mg_relax_c1bd = 0.0
                    right_mg_relax_c1b = 0.0
                end
                __idx_right_mg_relax_c1_stack_1_0 = prefix_right_mg_relax_c1_stack_1[(i_level - 1) + 1] + (((i_k_mg_relax_c1 - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j_mg_relax_c1 - 1)) + 1)
                ...
                right_mg_relax_c1b = 0.0
                if __branch_pre_2 == 1
                    ubd[i_j_mg_relax_c1 - 1, i_level] = ubd[i_j_mg_relax_c1 - 1, i_level] + left_mg_relax_c1bd
