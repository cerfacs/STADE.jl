    ...
    for i_level = 1:num_levels - 1
        ...
        for i_k = 1:nu1
            ...
            for i_j = 1:n
                ...
                __cse_16 = f[i_j, i_level]
                ud[i_j, i_level] = 0.5 * (((__cse_16 * hl2d + hl2 * fd[i_j, i_level]) + leftd) + rightd)
                u[i_j, i_level] = 0.5 * (hl2 * __cse_16 + left + right)
    ...
    for i_level = num_levels - 1:-1:1
        ...
        for i_k = 1:nu2
            ...
            for i_j = 1:n
                ...
                __cse_21 = f[i_j, i_level]
                ud[i_j, i_level] = 0.5 * (((__cse_21 * hl2d + hl2 * fd[i_j, i_level]) + leftd) + rightd)
                u[i_j, i_level] = 0.5 * (hl2 * __cse_21 + left + right)
    ...
    for i_level = 1:num_levels - 1
        for i_k = nu2:-1:1
            ...
            for i_j = n:-1:1
                ...
                __cse_2d = 0.5 * ubd[i_j, i_level]
                __cse_2 = 0.5 * ub[i_j, i_level]
                __cse_22 = f[i_j, i_level]
                hl2bd = hl2bd + (__cse_2 * fd[i_j, i_level] + __cse_22 * __cse_2d)
                hl2b = hl2b + __cse_22 * __cse_2
                fbd[i_j, i_level] = fbd[i_j, i_level] + (__cse_2 * hl2d + hl2 * __cse_2d)
    ...
    for i_level = num_levels - 1:-1:1
        ...
        for i_k = nu1:-1:1
            ...
            for i_j = n:-1:1
                ...
                __cse_13d = 0.5 * ubd[i_j, i_level]
                __cse_13 = 0.5 * ub[i_j, i_level]
                __cse_30 = f[i_j, i_level]
                hl2bd = hl2bd + (__cse_13 * fd[i_j, i_level] + __cse_30 * __cse_13d)
                hl2b = hl2b + __cse_30 * __cse_13
                fbd[i_j, i_level] = fbd[i_j, i_level] + (__cse_13 * hl2d + hl2 * __cse_13d)
                fb[i_j, i_level] = fb[i_j, i_level] + hl2 * __cse_13
                leftbd = leftbd + __cse_13d
                leftb = leftb + __cse_13
                rightbd = rightbd + __cse_13d
