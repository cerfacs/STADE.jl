...
function mg_vcycle_hv(u, ub, f, fb, r, rb, nfine, num_levels, h1, h1b, nu1, nu2, n, ud, ubd, fd, fbd, rd, rbd, h1d, h1bd, hl2_stack, tripcount_stack, left_stack, branch_stack, right_stack, u_stack, r_stack, f_stack, hl_stack, cl_stack, cr_stack, prefix_branch_stack_1, prefix_f_stack_1, prefix_hl2_stack_1, prefix_hl_stack_1, prefix_left_stack_1, prefix_r_stack_1, prefix_right_stack_1, prefix_tripcount_stack_1, prefix_u_stack_1, prefix_branch_stack_2, prefix_cl_stack_2, prefix_cr_stack_2, prefix_hl2_stack_2, prefix_hl_stack_2, prefix_left_stack_2, prefix_right_stack_2, prefix_tripcount_stack_2, prefix_u_stack_2, __tot_branch_stack_1, __tot_f_stack_1, __tot_hl2_stack_1, __tot_hl_stack_1, __tot_left_stack_1, __tot_r_stack_1, __tot_right_stack_1, __tot_tripcount_stack_1, __tot_u_stack_1, __tot_branch_stack_2, __tot_cl_stack_2, __tot_cr_stack_2, __tot_hl2_stack_2, __tot_hl_stack_2, __tot_left_stack_2, __tot_right_stack_2, __tot_tripcount_stack_2, __tot_u_stack_2, val_n_1, val_nc_1, val_n_2, val_nc_2)
    ...
    for i_level = 1:num_levels - 1
        ...
        for i_k = 1:nu1
            ...
            for i_j = 1:n
                ...
                if i_j > 1
                    ...
                    __idx_left_stack_1_0 = (prefix_left_stack_1[(i_level - 1) + 1] + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (((i_k - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                    left_stack_d[__idx_left_stack_1_0] = leftd
                    left_stack[__idx_left_stack_1_0] = left
                ...
                __idx_right_stack_1_4 = prefix_right_stack_1[(i_level - 1) + 1] + (((i_k - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                ...
                if i_j < n
                    ...
                    branch_stack[__idx_branch_stack_1_0] = 1
                    __idx_right_stack_1_0 = (prefix_right_stack_1[(i_level - 1) + 1] + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (((i_k - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                ...
                __idx_u_stack_1_8 = prefix_u_stack_1[(i_level - 1) + 1] + (((i_k - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                u_stack_d[__idx_u_stack_1_8] = ud[i_j, i_level]
                u_stack[__idx_u_stack_1_8] = u[i_j, i_level]
                ud[i_j, i_level] = 0.5 * (((f[i_j, i_level] * hl2d + hl2 * fd[i_j, i_level]) + leftd) + rightd)
                u[i_j, i_level] = 0.5 * (hl2 * f[i_j, i_level] + left + right)
                __idx_left_stack_1_11 = (prefix_left_stack_1[(i_level - 1) + 1] + ((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + (((i_k - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                left_stack_d[__idx_left_stack_1_11] = leftd
                left_stack[__idx_left_stack_1_11] = left
                __idx_right_stack_1_13 = (prefix_right_stack_1[(i_level - 1) + 1] + ((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + (((i_k - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                right_stack_d[__idx_right_stack_1_13] = rightd
                right_stack[__idx_right_stack_1_13] = right
            end
            __idx_left_stack_1_3 = (prefix_left_stack_1[(i_level - 1) + 1] + (((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((i_k - 1) + 1)
            left_stack_d[__idx_left_stack_1_3] = leftd
            left_stack[__idx_left_stack_1_3] = left
            __idx_right_stack_1_5 = (prefix_right_stack_1[(i_level - 1) + 1] + (((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((i_k - 1) + 1)
        ...
        for j = 1:n
            __idx_left_stack_1_0 = (prefix_left_stack_1[(i_level - 1) + 1] + ((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1))) + ((j - 1) + 1)
            left_stack_d[__idx_left_stack_1_0] = leftd
            left_stack[__idx_left_stack_1_0] = left
            leftd = 0.0
            left = 0.0
            if j > 1
                ...
                branch_stack[__idx_branch_stack_1_0] = 1
                __idx_left_stack_1_0 = (prefix_left_stack_1[(i_level - 1) + 1] + (((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((j - 1) + 1)
                left_stack_d[__idx_left_stack_1_0] = leftd
                left_stack[__idx_left_stack_1_0] = left
            ...
            __idx_right_stack_1_4 = (prefix_right_stack_1[(i_level - 1) + 1] + ((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1))) + ((j - 1) + 1)
            right_stack_d[__idx_right_stack_1_4] = rightd
            right_stack[__idx_right_stack_1_4] = right
            rightd = 0.0
            right = 0.0
            if j < n
                ...
                branch_stack[__idx_branch_stack_1_0] = 1
                __idx_right_stack_1_0 = (prefix_right_stack_1[(i_level - 1) + 1] + (((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((j - 1) + 1)
                right_stack_d[__idx_right_stack_1_0] = rightd
                right_stack[__idx_right_stack_1_0] = right
            ...
            __idx_left_stack_1_11 = (prefix_left_stack_1[(i_level - 1) + 1] + ((((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((j - 1) + 1)
            left_stack_d[__idx_left_stack_1_11] = leftd
            left_stack[__idx_left_stack_1_11] = left
            __idx_right_stack_1_13 = (prefix_right_stack_1[(i_level - 1) + 1] + ((((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((j - 1) + 1)
            right_stack_d[__idx_right_stack_1_13] = rightd
            right_stack[__idx_right_stack_1_13] = right
        end
        ncg = div(nl, 2)
        ...
        hld = 2.0hld
        hl = hl * 2.0
        __idx_left_stack_1_20 = (prefix_left_stack_1[(i_level - 1) + 1] + (((((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + 1
        left_stack_d[__idx_left_stack_1_20] = leftd
        left_stack[__idx_left_stack_1_20] = left
        __idx_right_stack_1_22 = (prefix_right_stack_1[(i_level - 1) + 1] + (((((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + 1
    ...
    for i_level = num_levels - 1:-1:1
        ...
        for i_k = 1:nu2
            ...
            for i_j = 1:n
                ...
                left_stack_d[__idx_left_stack_2_0] = leftd
                ...
                if i_j > 1
                    ...
                    branch_stack[__idx_branch_stack_2_0] = 1
                    __idx_left_stack_2_0 = ((__tot_left_stack_1 + prefix_left_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (((i_k - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                    left_stack_d[__idx_left_stack_2_0] = leftd
                    left_stack[__idx_left_stack_2_0] = left
                    leftd = ud[i_j - 1, i_level]
                    left = u[i_j - 1, i_level]
                ...
                __idx_right_stack_2_4 = (__tot_right_stack_1 + prefix_right_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (((i_k - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                right_stack_d[__idx_right_stack_2_4] = rightd
                ...
                if i_j < n
                    ...
                    branch_stack[__idx_branch_stack_2_0] = 1
                    __idx_right_stack_2_0 = ((__tot_right_stack_1 + prefix_right_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (((i_k - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                    right_stack_d[__idx_right_stack_2_0] = rightd
                ...
                __idx_u_stack_2_8 = (((__tot_u_stack_1 + 1) + prefix_u_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((div(val_nc_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div((val_nc_2[div(i_level - (num_levels - 1), -1) + 1] + 1) - 1, 1) + 1))) + (((i_k - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                u_stack_d[__idx_u_stack_2_8] = ud[i_j, i_level]
                u_stack[__idx_u_stack_2_8] = u[i_j, i_level]
                ud[i_j, i_level] = 0.5 * (((f[i_j, i_level] * hl2d + hl2 * fd[i_j, i_level]) + leftd) + rightd)
                u[i_j, i_level] = 0.5 * (hl2 * f[i_j, i_level] + left + right)
                __idx_left_stack_2_11 = ((__tot_left_stack_1 + prefix_left_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + (((i_k - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                left_stack_d[__idx_left_stack_2_11] = leftd
                left_stack[__idx_left_stack_2_11] = left
                __idx_right_stack_2_13 = ((__tot_right_stack_1 + prefix_right_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + (((i_k - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                right_stack_d[__idx_right_stack_2_13] = rightd
                right_stack[__idx_right_stack_2_13] = right
            end
            __idx_left_stack_2_3 = ((__tot_left_stack_1 + prefix_left_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + ((i_k - 1) + 1)
            left_stack_d[__idx_left_stack_2_3] = leftd
            left_stack[__idx_left_stack_2_3] = left
            __idx_right_stack_2_5 = ((__tot_right_stack_1 + prefix_right_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + ((i_k - 1) + 1)
        ...
        __idx_left_stack_2_21 = ((__tot_left_stack_1 + prefix_left_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1))) + 1
        left_stack_d[__idx_left_stack_2_21] = leftd
        left_stack[__idx_left_stack_2_21] = left
        __idx_right_stack_2_23 = ((__tot_right_stack_1 + prefix_right_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1))) + 1
    ...
    for i_level = 1:num_levels - 1
        ...
        __idx_left_stack_2_4 = ((__tot_left_stack_1 + prefix_left_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1))) + 1
        leftd = left_stack_d[__idx_left_stack_2_4]
        left = left_stack[__idx_left_stack_2_4]
        __idx_right_stack_2_6 = ((__tot_right_stack_1 + prefix_right_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1))) + 1
        rightd = right_stack_d[__idx_right_stack_2_6]
        right = right_stack[__idx_right_stack_2_6]
        for i_k = nu2:-1:1
            __idx_left_stack_2_0 = ((__tot_left_stack_1 + prefix_left_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + ((i_k - 1) + 1)
            leftd = left_stack_d[__idx_left_stack_2_0]
            left = left_stack[__idx_left_stack_2_0]
            __idx_right_stack_2_2 = ((__tot_right_stack_1 + prefix_right_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1)) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + ((i_k - 1) + 1)
            ...
            for i_j = n:-1:1
                __idx_left_stack_2_0 = ((__tot_left_stack_1 + prefix_left_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + (((i_k - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                leftd = left_stack_d[__idx_left_stack_2_0]
                left = left_stack[__idx_left_stack_2_0]
                __idx_right_stack_2_2 = ((__tot_right_stack_1 + prefix_right_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + ((div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (div(nu2 - 1, 1) + 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1))) + (((i_k - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                rightd = right_stack_d[__idx_right_stack_2_2]
                right = right_stack[__idx_right_stack_2_2]
                ...
                __idx_right_stack_2_0 = (__tot_right_stack_1 + prefix_right_stack_2[div(i_level - (num_levels - 1), -1) + 1]) + (((i_k - 1) * (div(val_n_2[div(i_level - (num_levels - 1), -1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                rightd = right_stack_d[__idx_right_stack_2_0]
    ...
    hl2b = 0.0
    for i_level = num_levels - 1:-1:1
        __idx_left_stack_1_0 = (prefix_left_stack_1[(i_level - 1) + 1] + (((((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + 1
        leftd = left_stack_d[__idx_left_stack_1_0]
        left = left_stack[__idx_left_stack_1_0]
        __idx_right_stack_1_2 = (prefix_right_stack_1[(i_level - 1) + 1] + (((((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + 1
        ...
        for j = n:-1:1
            __idx_left_stack_1_0 = (prefix_left_stack_1[(i_level - 1) + 1] + ((((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((j - 1) + 1)
            leftd = left_stack_d[__idx_left_stack_1_0]
            left = left_stack[__idx_left_stack_1_0]
            __idx_right_stack_1_2 = (prefix_right_stack_1[(i_level - 1) + 1] + ((((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((j - 1) + 1)
            rightd = right_stack_d[__idx_right_stack_1_2]
            right = right_stack[__idx_right_stack_1_2]
            ...
            __idx_right_stack_1_0 = (prefix_right_stack_1[(i_level - 1) + 1] + ((((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1))) + ((j - 1) + 1)
        ...
        for i_k = nu1:-1:1
            __idx_left_stack_1_0 = (prefix_left_stack_1[(i_level - 1) + 1] + (((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((i_k - 1) + 1)
            leftd = left_stack_d[__idx_left_stack_1_0]
            left = left_stack[__idx_left_stack_1_0]
            __idx_right_stack_1_2 = (prefix_right_stack_1[(i_level - 1) + 1] + (((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1)) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + ((i_k - 1) + 1)
            rightd = right_stack_d[__idx_right_stack_1_2]
            right = right_stack[__idx_right_stack_1_2]
            __idx_tripcount_stack_1_4 = prefix_tripcount_stack_1[(i_level - 1) + 1] + ((i_k - 1) + 1)
            n = tripcount_stack[__idx_tripcount_stack_1_4]
            for i_j = n:-1:1
                __idx_left_stack_1_0 = (prefix_left_stack_1[(i_level - 1) + 1] + ((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + (((i_k - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                leftd = left_stack_d[__idx_left_stack_1_0]
                left = left_stack[__idx_left_stack_1_0]
                __idx_right_stack_1_2 = (prefix_right_stack_1[(i_level - 1) + 1] + ((div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (div(nu1 - 1, 1) + 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1))) + (((i_k - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                rightd = right_stack_d[__idx_right_stack_1_2]
                right = right_stack[__idx_right_stack_1_2]
                ...
                __idx_right_stack_1_0 = prefix_right_stack_1[(i_level - 1) + 1] + (((i_k - 1) * (div(val_n_1[(i_level - 1) + 1] - 1, 1) + 1) + (i_j - 1)) + 1)
                rightd = right_stack_d[__idx_right_stack_1_0]
                right = right_stack[__idx_right_stack_1_0]
                rightbd = 0.0
                rightb = 0.0
