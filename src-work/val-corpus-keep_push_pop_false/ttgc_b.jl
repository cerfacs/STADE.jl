function initstacks_ttgc_b(i_ncell, i_njac, i_nnode, npernode_half)
    ...
    res_stack = Vector{Float64}(undef, ((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(npernode_half - 1, 1) + 1)) + (div(npernode_half - 1, 1) + 1))
    res2_stack = Vector{Float64}(undef, (((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(npernode_half - 1, 1) + 1)) + (div(npernode_half - 1, 1) + 1))
    up_stack = Vector{Float64}(undef, (((div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + (div(i_nnode - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1))
    mup_stack = Vector{Float64}(undef, (((((((((((((div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(npernode_half - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(npernode_half - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(i_ncell - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(npernode_half - 1, 1) + 1)) + (div(i_njac - 1, 1) + 1) * (div(npernode_half - 1, 1) + 1))
...
function ttgc_b(u, ub, uref, urefb, i_cell_to_node, cell_vol, cell_volb, node_vol, node_volb, skx, skxb, sky, skyb, skz, skzb, i_ncell, i_nnode, c, cb, dt, dtb, beta, betab, gamma, gammab, i_njac, res, resb, res2, res2b, up, upb, mup, mupb, npernode_half, resperio, resperiob, i_node_perio, loss, lossb, cavgx_stack, cavgy_stack, cavgz_stack, vere_stack, re_stack, aerex_stack, aerey_stack, aerez_stack, aeresk_stack, factor_stack, res_stack, res2_stack, up_stack, mup_stack, auxu_stack)
    ...
    for i_cell = 1:i_ncell
        ...
        for i_loc = 1:4
            ...
            for i_k = 1:4
                ...
                res_stack[((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1] = res[i_k_node]
                res[i_k_node] = res[i_k_node] + auxres
                res2_stack[((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1] = res2[i_k_node]
    ...
    for k = 1:npernode_half
        i1 = i_node_perio[k, 1]
        i2 = i_node_perio[k, 2]
        res_stack[(div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + ((k - 1) + 1)] = res[i1]
        res[i1] = res[i1] + resperio[k, 2]
        res_stack[((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(npernode_half - 1, 1) + 1)) + ((k - 1) + 1)] = res[i2]
        res[i2] = res[i2] + resperio[k, 1]
    end
    for i_node = 1:i_nnode
        up_stack[(i_node - 1) + 1] = up[i_node]
    ...
    for i_seq_ = 1:i_njac
        ...
        for i_node = 1:i_nnode
            up_stack[(div(i_nnode - 1, 1) + 1) + (((i_seq_ - 1) * (div(i_nnode - 1, 1) + 1) + (i_node - 1)) + 1)] = up[i_node]
    ...
    for i_cell = 1:i_ncell
        for i_loc = 1:4
            ...
            for i_k = 1:4
                i_k_node = i_cell_to_node[i_k, i_cell]
                res2_stack[(div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1)] = res2[i_k_node]
    ...
    for k = 1:npernode_half
        i1 = i_node_perio[k, 1]
        i2 = i_node_perio[k, 2]
        res2_stack[((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + ((k - 1) + 1)] = res2[i1]
        res2[i1] = res2[i1] + resperio[k, 2]
        res2_stack[(((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(npernode_half - 1, 1) + 1)) + ((k - 1) + 1)] = res2[i2]
        res2[i2] = res2[i2] + resperio[k, 1]
    end
    for i_node = 1:i_nnode
        up_stack[((div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + ((i_node - 1) + 1)] = up[i_node]
    ...
    for i_seq_ = 1:i_njac
        ...
        for i_node = 1:i_nnode
            up_stack[(((div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + (div(i_nnode - 1, 1) + 1)) + (((i_seq_ - 1) * (div(i_nnode - 1, 1) + 1) + (i_node - 1)) + 1)] = up[i_node]
    ...
    for i_seq_ = i_njac:-1:1
        ...
        for i_node = i_nnode:-1:1
            up[i_node] = up_stack[(((div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + (div(i_nnode - 1, 1) + 1)) + (((i_seq_ - 1) * (div(i_nnode - 1, 1) + 1) + (i_node - 1)) + 1)]
    ...
    for i_node = i_nnode:-1:1
        up[i_node] = up_stack[((div(i_nnode - 1, 1) + 1) + (div(i_njac - 1, 1) + 1) * (div(i_nnode - 1, 1) + 1)) + ((i_node - 1) + 1)]
        res2b[i_node] = res2b[i_node] + (1.0 / node_vol[i_node]) * upb[i_node]
    ...
    for k = npernode_half:-1:1
        i1 = i_node_perio[k, 1]
        i2 = i_node_perio[k, 2]
        res2[i2] = res2_stack[(((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (div(npernode_half - 1, 1) + 1)) + ((k - 1) + 1)]
        resperiob[k, 1] = resperiob[k, 1] + res2b[i2]
        res2[i1] = res2_stack[((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + ((k - 1) + 1)]
    ...
    for i_cell = i_ncell:-1:1
        ...
        for i_loc = 4:-1:1
            ...
            for i_k = 4:-1:1
                i_k_node = i_cell_to_node[i_k, i_cell]
                res2[i_k_node] = res2_stack[(div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1)]
    ...
    for i_seq_ = i_njac:-1:1
        ...
        for i_node = i_nnode:-1:1
            up[i_node] = up_stack[(div(i_nnode - 1, 1) + 1) + (((i_seq_ - 1) * (div(i_nnode - 1, 1) + 1) + (i_node - 1)) + 1)]
    ...
    for k = npernode_half:-1:1
        i1 = i_node_perio[k, 1]
        i2 = i_node_perio[k, 2]
        res[i2] = res_stack[((div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + (div(npernode_half - 1, 1) + 1)) + ((k - 1) + 1)]
        resperiob[k, 1] = resperiob[k, 1] + resb[i2]
        res[i1] = res_stack[(div(i_ncell - 1, 1) + 1) * (div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1) + ((k - 1) + 1)]
    ...
    for i_cell = i_ncell:-1:1
        ...
        for i_loc = 4:-1:1
            ...
            for i_k = 4:-1:1
                i_k_node = i_cell_to_node[i_k, i_cell]
                res2[i_k_node] = res2_stack[((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1]
                auxres2b = auxres2b + res2b[i_k_node]
                res[i_k_node] = res_stack[((i_cell - 1) * ((div(4 - 1, 1) + 1) * (div(4 - 1, 1) + 1)) + (i_loc - 1) * (div(4 - 1, 1) + 1) + (i_k - 1)) + 1]
