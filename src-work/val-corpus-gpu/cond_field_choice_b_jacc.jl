...
function jacc_kernel_cond_field_choice_b_3!(__jacc_i, loss, __jgen_redval)
...
function cond_field_choice_b_jacc(loss, lossb, u, ub, v, vb, w, wb, i_branch, i_n, branch_stack)
    ...
    JACC.@parallel_for range = 1 jacc_kernel_cond_field_choice_b_3!(loss, __jgen_redval_3)
