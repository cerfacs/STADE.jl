...
function cuda_kernel_weightedsumsq_b_1!(i_n, lossb, u, ub, w, wb)
...
function weightedsumsq_b_cuda(loss, lossb, u, ub, w, wb, i_n)
    ...
    @cuda threads = nthread_per_block blocks = cld(div(1 - i_n, -1) + 1, nthread_per_block) cuda_kernel_weightedsumsq_b_1!(i_n, lossb, u, ub, w, wb)
    return nothing
end
