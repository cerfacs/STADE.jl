    ...
    for i_seq_level = 1:num_levels - 1
        ...
        for i_seq_k = 1:nu1
            ...
            for i_seq_j = 1:n
                ...
                u_stack_d[__idx_u_stack_1_8] = ud[i_seq_j, i_seq_level]
    ...
    for i_seq_level = num_levels - 1:-1:1
        ...
        for i_seq_k = 1:nu2
            ...
            for i_seq_j = 1:n
                ...
                u_stack_d[__idx_u_stack_2_8] = ud[i_seq_j, i_seq_level]
    ...
    for i_seq_level = 1:num_levels - 1
        ...
        for i_seq_k = nu2:-1:1
            ...
            for i_seq_j = n:-1:1
                ...
                ud[i_seq_j, i_seq_level] = u_stack_d[__idx_u_stack_2_0]
    ...
    for i_seq_level = num_levels - 1:-1:1
        ...
        for i_seq_k = nu1:-1:1
            ...
            for i_seq_j = n:-1:1
                ...
                ud[i_seq_j, i_seq_level] = u_stack_d[__idx_u_stack_1_0]
