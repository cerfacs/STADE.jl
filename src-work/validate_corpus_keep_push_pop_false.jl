...
"""
    validate_corpus_keep_push_pop_false(dir="val-corpus-keep_push_pop_false"; trials=8)
...
"""
function validate_corpus_keep_push_pop_false(dir::String = "val-corpus-keep_push_pop_false"; trials::Int = 8)
    ...
    for f in sort(
        ...
        for mode in (:tangent, :adjoint, :hvp)
            ...
            try
                gen_fn(path, out_path; keep_push_pop = false)
            catch e
...
validate_corpus_keep_push_pop_false()